...
humandate: "August 1,8,15,22 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Taylor Woods", "Stephen Formel", "Adrian Moore", "Gregor Siegmund", "Kaitlyn Elliott"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p id="requirements">
  ...
  {% endif %}
  They should have already downloaded and installed the below mentioned software installed (listed <a href="#setup">below</a>). This may require asking IT to do the installations.
</p>
